...
Special thanks to AbyssalCreature for playtesting!
...
- Winning on each difficulty with a 50% and/or 100% Performance Rating, as well as defeating early phases without taking damage (no-hit run) (Hellfire Ridley Phase 3 not included)
- Speedrunning phase 1 and 2 on any difficulty in extremely quick times

Note: If you get a check on a higher difficulty, you automatically get all the checks for the same challenge on lower difficulties. However, this rule DOES NOT apply to Hellfire Ridley Phase 2 since it is much shorter than the other Phase 2's.
